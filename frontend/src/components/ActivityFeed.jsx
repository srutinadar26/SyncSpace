    ...
    <div className="rounded-xl border border-gray-200 bg-white shadow-sm">
      ...
      <div className="max-h-[420px] overflow-y-auto">
        {loading ? (
          ...
          <p className="px-4 py-6 text-center text-xs text-gray-400">No activity yet.</p>
        ) : (
              ...
              <li key={entry._id} className="flex items-start gap-3 px-4 py-3">
                <span
                  className={`mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-xs ${
                    entry.sensitive ? "bg-amber-100 text-amber-700" : "bg-indigo-50 text-[var(--color-accent)]"
                  }`}
                >
